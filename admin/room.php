        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="vacate.php"><i class="fa fa-pencil-square-o"></i> Vacate Room</a>
                    </li>
                            ...
                            <div class="panel-body">
							 ...
							 if(isset($_POST['add']))
							 {
										...
										$place = 'Available';
                                            ...
                                            $sql ="INSERT INTO `room`( `room_type`, `bedding_type`,`status`) VALUES ('$room','$bed','$place')" ;
