...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 20, 2018 at 12:13 AM
...
(27, 'Mr.', 'Ali', 'Rehan', 'Bahrain', 'fraznadeem955@gmail.com', '0000000000'),
(28, 'Mrs.', 'Elsa', 'Faust', 'Belarus', 'elsa@hotmail.com', '98765412');
...
(3, 27, 'Single', 'Breakfast', '2018-12-25', '2018-12-27', 'Not Available', 2, 'Luxury'),
...
ALTER TABLE `room`
  ...
  ADD KEY `FK_meal` (`meal_type`),
  ADD KEY `FK_category` (`room_type`);
...
--
ALTER TABLE `customer`
  MODIFY `customer_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `room`
  ADD CONSTRAINT `FK_category` FOREIGN KEY (`room_type`) REFERENCES `room_category` (`room_types`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_customer` FOREIGN KEY (`customer`) REFERENCES `customer` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_meal` FOREIGN KEY (`meal_type`) REFERENCES `meal` (`meal_name`) ON DELETE CASCADE ON UPDATE CASCADE;
